...
export const api = {
  ...
  deleteNodeOne: (payload) => request('/nodes/delete-one', { method: 'DELETE', body: JSON.stringify(payload) }),
  deleteNodeMany: (payload) => request('/nodes/delete-many', { method: 'DELETE', body: JSON.stringify(payload) }),
  aggregateNodes: (payload) => request('/nodes/aggregate', { method: 'POST', body: JSON.stringify(payload) }),
  createRelationship: (payload) => request('/relationships', { method: 'POST', body: JSON.stringify(payload) }),
  addRelationshipPropertiesOne: (payload) => request('/relationships/properties/add-one', { method: 'PATCH', body: JSON.stringify(payload) }),
  updateRelationshipPropertiesOne: (payload) => request('/relationships/properties/update-one', { method: 'PATCH', body: JSON.stringify(payload) }),
  deleteRelationshipPropertiesOne: (payload) => request('/relationships/properties/delete-one', { method: 'DELETE', body: JSON.stringify(payload) }),
  addRelationshipPropertiesMany: (payload) => request('/relationships/properties/add-many', { method: 'PATCH', body: JSON.stringify(payload) }),
  updateRelationshipPropertiesMany: (payload) => request('/relationships/properties/update-many', { method: 'PATCH', body: JSON.stringify(payload) }),
  deleteRelationshipPropertiesMany: (payload) => request('/relationships/properties/delete-many', { method: 'DELETE', body: JSON.stringify(payload) }),
  deleteRelationshipOne: (payload) => request('/relationships/delete-one', { method: 'DELETE', body: JSON.stringify(payload) }),
  deleteRelationshipMany: (payload) => request('/relationships/delete-many', { method: 'DELETE', body: JSON.stringify(payload) }),
};
