...
El caso de uso seleccionado es el de motor de recomendación. La base de datos representa películas, géneros, directores y usuarios simulados con sus vistas, calificaciones, preferencias y relaciones de amistad. Con esta estructura se pueden ejecutar consultas de filtrado, agregación, recomendaciones y validación de conectividad del grafo.
...
\begin{enumerate}
    ...
    \item Carga de nodos Movie, User y Director.
    \item Carga de relaciones DIRECTED, HAS\_GENRE, VIEWED, RATED, PREFERS y FRIEND\_OF.
...
\begin{enumerate}
    ...
    \item Implementar el backend mínimo de consulta y CRUD.
    \item Incorporar el algoritmo de recomendación.
    \item Preparar el guion de presentación final.
    \item Completar la sección de diagramas y explicación formal del modelo.
\end{enumerate}
...
El detalle completo de la validación puede consultarse en \texttt{docs/reports/validation\_post\_load\_report.md}.
